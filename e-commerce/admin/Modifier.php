...
$rec=mysqli_query($db, "SELECT * FROM produit WHERE id_produit=$id");
$record=mysqli_fetch_array($rec);
$nom=$record['nom_produit'];
$prix=$record['prix_produit'];
$quantite=$record['quantite'];
$image=$record['image_1_produit'];
$id=$record['id_produit'];
}
    ...
    <div class="cart-table-area section-padding-100">
        <div class="container-fluid">
            <div class="row">
                        ...
                        <form action="Modifier.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <input type="text" class="form-control" name="nom" value="<?php echo $nom;?>" placeholder="Nom" required>
                                </div>
				...
				<div class="form-check">
                        <input class="form-check-input" type="radio" value="<?php echo $categorie;?>" name="ikea">
				...
				<div class="form-check">
					...
					<div class="form-check">
                        <input class="form-check-input" type="radio" value="" name="ikea">
     ...
     <div class="col-md-6 mb-3">
                ...
                <div class="widget-desc">
                    <!-- Single Form Check -->
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="<?php echo $marque;?>" name="amado">
                        <label class="form-check-label" for="amado">Amado</label>
                    </div>
                    <!-- Single Form Check -->
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="<?php echo $marque;?>" name="ikea">
                        <label class="form-check-label" for="ikea">Ikea</label>
                    </div>
                    <!-- Single Form Check -->
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="<?php echo $marque;?>" name="furniture">
                        <label class="form-check-label" for="furniture">Furniture Inc</label>
                    </div>
                    <!-- Single Form Check -->
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="<?php echo $marque;?>" name="factory">
                        <label class="form-check-label" for="factory">The factory</label>
                    </div>
                    <!-- Single Form Check -->
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="<?php echo $marque;?>" name="artdeco">
       ...
       <div class="widget color mb-50">
                ...
                <div class="widget-desc"><input type="checkbox" name="couleur[]" value="rouge">Rouge<br/>
		...
		<br>
				  ...
				  <div class="col-md-10 mb-3">
						...
						<a href="Produits.php" method="POST">
                                       <button type="submit" name="update" class="btn amado-btn w-100" >Valider</button>
									   </a></div>
